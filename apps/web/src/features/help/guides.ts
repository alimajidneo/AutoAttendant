...
export const guides: Guide[] = [
  {
    ...
    steps: [
      ...
      { title: 'Connect calendars and try a call', detail: 'Follow the Google calendars guide, then the Test your agent guide. Confirm the appointment appears in the intended calendar before using the receptionist with customers.' },
    ],
  ...
  },
  {
    ...
    summary: 'Connect several Google accounts and choose which calendars affect appointments.',
    steps: [
      { title: 'Open calendar settings', detail: 'Go to Settings → Connections → Google Calendar. Choose Connect or Manage, then Connect Google Calendar for your first connection.' },
      { title: 'Authorize the intended account', detail: 'Choose the Google account whose calendar you want to connect and review the requested access. Return to DeskRoute after approval. This does not change the account you use to sign in to DeskRoute.' },
      { title: 'Add another Google account', detail: 'In the same panel, choose Connect account and select your other Gmail or Google Workspace account. Confirm that both accounts appear in the list.' },
    ...
    notes: [
      { title: 'A connected account’s event is missing', detail: 'Check that its calendar is selected, save, refresh and navigate to the correct date. Events created directly in Google appear in the calendar and daily agenda; the Upcoming and Past lists contain DeskRoute bookings.' },
      ...
      { title: 'What about Outlook or Microsoft 365?', detail: 'Microsoft calendars are planned but are not connected by this Google flow. The next calendar integration will cover personal Outlook and work Microsoft 365 accounts.' },
    ],
  },
  {
    ...
    notes: [{ title: 'Are all outside changes synchronized?', detail: 'Full rescheduling and external-change synchronization are still being completed. Do not assume that moving a Google event updates every DeskRoute booking field. Verify both records when a time changes.' }],
  },
  {
    ...
    notes: [{ title: 'Will I get a Slack, email or phone alert?', detail: 'Not yet. The current bell is an in-app feed of up to 50 records from the last 30 days. It does not continuously poll or send push, email, SMS or Slack messages. Open or refresh it to check new activity.' }],
  },
  {
    ...
    steps: [
      ...
      { title: 'Verify the result', detail: 'End the test and refresh Appointments. Check that the booking exists in the chosen Google calendar and that busy times were rejected. Cancel the test appointment when finished.' },
    ],
